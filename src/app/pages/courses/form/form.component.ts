...
export class FormComponent implements OnInit {
  ...
  constructor(private service: CoursesService, private active: ActivatedRoute, private router: Router, private builder: FormBuilder) {
  ...
  onSubmit() {
    ...
    this.service.save(this.form.value).subscribe(() => this.router.navigate(['/courses']));
  }
